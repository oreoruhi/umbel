...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="font-family: 'Pacifico', Helvetica, sans-serif;"><u>Order Review</u></h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-9 clearfix" id="basket">
                        ...
                        <div class="box">
                            ...
                            <div class="table-responsive" style="font-family:'Comfortaa', Helvetica, sans-serif;">
                                <form action="timeWait.php?id=<?php echo $getID;?>" method="POST">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <td colspan = "5"><center>Single Bundles</center></td>
                                            </tr>
                                            <tr>
                                        ...
                                        ?>
                                            <tr >
                                                <td colspan="5"><center>Your Cart list for single bundles is empty</center></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        <thead>
                                        <tr>
                                            <td colspan="5"><center>Arranged bouquets</center></td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        ?>
                                            <tr >
                                                <td colspan="5"><center>Your Cart list for arranged bouquets is empty</center></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
