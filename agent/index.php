    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="index.php"><i class="fa fa-dashboard fa-fw"></i> Order Report</a>
                        </li>
                        <li>
                            <a href="products.php"><i class="fa fa-list fa-fw"></i> Walk-In and Phone Orders</a>
                        </li>
        ...
        <div id="page-wrapper">
            ...
            ?>
                <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                Welcome to the Umbel Family, Agent!
                </div>
            <?php
            }
                if(isset($_GET['taken'])){
