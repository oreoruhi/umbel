...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="font-family: 'Pacifico', Helvetica, sans-serif;"><u>Single Bundles</u></h1>
                    </div>
                </div>
            </div>
        </div>
		  ...
		  <div id="content">
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                        ...
                        <p class="text-muted lead">Our roster of floral products provides a wide selection of flowers -- all fresh and carefully cultivated.</p>
                        ...
                        <?php
                            ...
                            if(isset($_GET['searchProd']) && !empty($_GET['searchProd'])){
                                $name = $_GET['searchProd'];
                                $query="SELECT * FROM product WHERE p_status!='Archived' AND p_name LIKE '%$name%' LIMIT $start_from, $per_page";
                            } else {
                                $query="SELECT * FROM product WHERE p_status!='Archived' LIMIT $start_from, $per_page";
                            }
                        ...
                        ?>
                            ...
                            <div class="box-image">
                                <div class="image">
                                    <?php
                                    if($row1['p_img'] != "uploads/"){
                                    ?>
                                    <center><img src="<?php echo $row1['p_img'];?>" alt="" class="img-responsive" style="height:250px;"></center>
                                    <?php
                                    } else {
                                    ?>
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h4 style="font-family:'Comfortaa', Helvetica, sans-serif; color: white;"><?php echo $row1['p_desc'];?></h4>
                                </div>
                            </div>
                                    <!-- /.image -->
                                    <div>
                                        <h4 style="font-family:'Comfortaa', Helvetica, sans-serif;"><b><?php echo $row1['p_name']; ?></b></h4>
                                        <p class="text-muted">Price: <?php echo "PHP " . $row1['p_price'] . ".00"; ?></p>
                                        <a href="cart.php?id=<?php echo $row1['p_ID'];?>" class="btn btn-template-primary btn-small"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        <br>
                                        <br>
                                    </div>
                                    <!-- /.text -->
                ...
                ?>
                        ...
                        <div class="pages">
                            ...
                            if(isset($_GET['searchProd'])){
                                $queryPage="SELECT * FROM product WHERE p_status!='Archived' AND p_name LIKE '%$name%'";
                            } else {
                                $queryPage="SELECT * FROM product WHERE p_status!='Archived'";
                            }
                            ...
                            ?>
                            <ul class="pagination">
                                <li><a href="singles.php?page=1">First Page</a>
                                </li>
                                <?php
                                for($i=1; $i<=$total_pages;$i++){
                                    if($i == $page){
                                ?>
                                <li class="active"><a href="singles.php?page=<?php echo $i;?>"><?php echo $i; ?></a>
                                </li>
                                <?php
                            }
                                    else{
                                ?>
                                <li><a href="singles.php?page=<?php echo $i;?>"><?php echo $i; ?></a>
                                </li>
                                <?php
                                    }    
                                }
                                ?>
                                <li><a href="singles.php?page=<?php echo $total_pages;?>">Last Page</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="panel-body">
                                <form role="search">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search for single bundles..." name= 'searchProd'>
                                        <span class="input-group-btn">
