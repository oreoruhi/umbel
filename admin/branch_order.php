    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class = "active" href="branch_order.php"><i class="fa fa-reorder fa-fw"></i> Branch Order</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            ?>
                ...
                You have successfully approved a branch's request for stock!
                </div>
            <?php
            }   
            ...
            ?>
                <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                You have denied a branch's request for stock.
                </div>
            <?php
            }   if(isset($_GET['fail'])){
            ?>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											<th><center>Branch Request ID</center></th>
                                            <th><center>Branch Name</center></th>
                                            <th><center>Requested Product</center></th>
											<th><center>Requested Stock</center></th>
                                    ...
                                    <tbody>
											...
											<?php
													$sql = "SELECT branch.*, product.*, stock.*, branch_request.* 
                                                    FROM branch_request 
                                                    LEFT JOIN branch 
                                                    ON (branch_request.b_ID = branch.b_ID) 
                                                    LEFT JOIN product
                                                    ON (branch_request.p_id = product.p_ID)
                                                    LEFT JOIN stock
                                                    ON (branch_request.s_id = stock.s_ID)
											...
											?>
											<tr class="odd gradeX">
											<td><center><?php echo $row['br_ID'];?></center></td>
                                            <td><center><?php echo $row['b_name'];?></center></td>
                                            <td><center><?php echo $row['p_name'];?></center></td>
                                            <td><center><?php echo $row['br_stock'];?></center></td>
                                            <td><center><a href = "../functions/pro_approveRequest.php?id=<?php echo $row['br_ID']; ?>"><button type="button" class="btn btn-success btn-sm"><span class="fa fa-thumbs-up"></span> Approve Request</button></a></center></td>
                                            <td><center><a href = "../functions/pro_denyRequest.php?id=<?php echo $row['br_ID']; ?>"><button type="button" class="btn btn-danger btn-sm"><b>x</b> Deny Request</button></a></center></td>
											</tr>
										<?php
											}
											}
