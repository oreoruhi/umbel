            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class ="active" href="feedback.php"><i class="fa fa-thumbs-up fa-fw"></i> Customer Feedback</a>
                        </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>Messsage Type</center></th>
                                            <th><center>Date and Time Submitted</center></th>
                                    ...
                                    <tbody>
                                            ...
                                            <td><center><?php echo $row['f_name'];?></center></td>
                                            <td><center><?php echo $row['f_email']?></center></td>
                                            <td><center><?php echo $row['f_subject']?></center></td>
                                            <td><center><?php echo $row['f_type']?></center></td>
                                            <td><center><?php echo $row['f_time']?></center></td>
                                            <td><center><a href = "read.php?id=<?php echo $row['f_ID'];?>"><button type="button" class="btn btn-info btn-sm"><span class="fa fa-list fa-fw"></span> Read</button></a></center></td>
                                            <?php
                                            if($row['f_type'] !='Inquiry' && isset($row['f_email'])){
                                            ?>
                                            <td><center><a href = "respond.php?id=<?php echo $row['f_ID'];?>"><button type="button" class="btn btn-info btn-sm" disabled><span class="fa fa-mail-reply fa-fw"></span> Respond</button></a></center></td>
                                            <?php
                                            } else{
                                            ?>
                                            <td><center><a href = "respond.php?id=<?php echo $row['f_ID'];?>"><button type="button" class="btn btn-info btn-sm"><span class="fa fa-mail-reply fa-fw"></span> Respond</button></a></center></td>
                                            <?php
                                            }
                                            ?>
                                            <td><center><a href = "../functions/pro_delFeed.php?id=<?php echo $row['f_ID'];?>"><button type="button" class="btn btn-danger btn-sm"><b>x</b> Delete</button></a></center></td>
