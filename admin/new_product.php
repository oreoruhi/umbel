    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                ?>
                <div class="col-lg-12">
                    <h1 class="page-header">Adding a new product</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_addProduct.php" enctype="multipart/form-data">
                                                    ...
                                                    <textarea class="form-control" name='p_desc' rows="3"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                    <label>Stock *</label>
                                                    <input type="number" name="p_stock" class= "form-control" min="0"/> 
                                                    </div>							
													<div class="form-group">
