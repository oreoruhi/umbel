    ...
    <div id="wrapper">
        ...
        <?php
            ...
            ?>
                ...
                Something went wrong while processing your request. Be sure to have the important fields filled out.
                </div>
            <?php
            }   
            ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Updating product: <?php echo $row['p_name']; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_editProduct.php?id=<?php echo $id;?>" enctype="multipart/form-data">
													<div class="form-group">
                                                    <label>Flower Name</label>
                                                    <input class="form-control" name='p_name' value="<?php echo $row['p_name'];?>">
                                                    </div>
                                                    <div class="form-group">
                                                    <label>Description</label>
                                                    <textarea class="form-control" name='p_desc' rows="3"><?php echo $row['p_desc'];?></textarea>
                                                    </div>			
													<div class="form-group">
                                                    <label>Price (per piece)</label>
                                                    <input type="number" name="p_price" onkeypress="return isNumberKey(event)" class= "form-control"/> 
                                                    </div>
													<div class="form-group">
