    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <?php
				...
				$query="SELECT * FROM bouquet WHERE bo_ID='$id'";
				$queryResult=mysqli_query($con, $query);
				$echoQuery=mysqli_fetch_assoc($queryResult);
				?>
                    <h1 class="page-header"><?php echo $echoQuery['bo_name']; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_newBouquetType.php?id=<?php echo $id;?>&name=<?php echo $echoQuery['bo_name']; ?>">
                                                    <?php
													...
													<div class="form-group">
														...
														<input type="number" name="b_num[<?php echo $row['p_ID']; ?>]" class= "form-control" min="0"/> 
                                                    </div>	
													<?php
													}
													}
