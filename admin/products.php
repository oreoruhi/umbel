            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="products.php"><i class="fa fa-list fa-fw"></i> Flowers</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
						   Umbel Flowers
                           <span class="navbar-right"><a href = 'new_product.php'><button type="button" class="btn btn-primary btn-xs">Add a product</button></a></span>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php
									$sql = "SELECT * FROM product WHERE p_status != 'Archived'";	
										...
										<tr class="odd gradeX">
											...
											if($row['p_stock'] > 500){
											?>
											<td><center><?php echo $row['p_stock']; ?></center></td>
											<?php
											}
											else{
											?>
											<td style="color:red;"><center><?php echo $row['p_stock']; ?></center>
											<center><span class="text-muted">Stock level: critical</span></center></td>
											<?php
											}
											?>
											<td><center><a href = "productUpdate.php?id=<?php echo $row['p_ID'];?>"><button type="button" class="btn btn-success btn-sm"><span class="fa fa-edit"></span> Update</button></a></center></td>
											<?php
											if($row['p_stock'] > 500){
											?>
											<td><center><form action="../functions/requestStock.php?id=<?php echo $row['p_ID'];?>" method="POST">
                                                <input type="number" class="form-control" style="width: 70px;" name="stockNum" disabled min="1"/> &nbsp
                                                <button type="submit" class="btn btn-warning btn-sm" disabled><span class="fa fa-share-square-o"></span> Update Stock</button>
                                                </form>
                                            </center></td>
											<?php
											}else{
											...
											<td><center><form action="../functions/requestStock.php?id=<?php echo $row['p_ID'];?>" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-warning btn-sm"><span class="fa fa-share-square-o"></span> Update Stock</button>
                                                </form>
                                            </center></td>
											<?php
											}
											...
											if($row['p_stock'] > 0){
											?>
											<td><center><a href = "#"><button type="button" class="btn btn-danger btn-sm" disabled><span class="fa fa-archive"></span> Archive</button></a></center></td>
											<?php
											}else{
											?>
											<td><center><a href = "../functions/pro_delProduct.php?id=<?php echo $row['p_ID'];?>"><button type="button" class="btn btn-danger btn-sm"><span class="fa fa-archive"></span> Archive</button></a></center></td>
											<?php
											}
											?>
										</td>
