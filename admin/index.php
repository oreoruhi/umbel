                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php
                                        $sql2="SELECT * FROM bouquet WHERE bo_status='Available'";
                                        $result2=mysqli_query($con, $sql2);
                                        $row2=mysqli_num_rows($result2);
                                    ?>
                                    <div class="huge"><?php echo $row2; ?></div>
                                    <div>Bouquet Types</div>
                                </div>
                            </div>
                        </div>
                        <a href="feedback.php">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php
                                        $sql3="SELECT * FROM branch WHERE b_status !='Unmanaged'";
                                        $result3=mysqli_query($con, $sql3);
                                        $row3=mysqli_num_rows($result3);
                                    ?>                                   
                                    <div class="huge"><?php echo $row3; ?></div>
                                    <div>Managed Branches</div>
                                </div>
                            </div>
                        </div>
                        <a href="branches.php">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php
                                        $sql4="SELECT * FROM user WHERE u_position !='Administrator'";
                                        $result4=mysqli_query($con, $sql4);
                                        $row4=mysqli_num_rows($result4);
                                    ?> 
                                    <div class="huge"><?php echo $row4; ?></div>
                                    <div>Employees</div>
                                </div>
                            </div>
                        </div>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					 <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><i class="fa fa-bell fa-fw"></i> Available Stock for Distribution</center>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="list-group">
                               ...
                               while($row5 = mysqli_fetch_array($result1)){
                                ?>
                                    ...
                                    <span class="pull-right"><?php echo $row5['p_stock'];?>
                                    </span><br>
                                <?php
                                 }
                                ?>
