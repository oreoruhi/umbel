...
<body>
    <div id="wrapper">
        ...
        <?php
        $id=$_GET['id'];
        $sql1="SELECT * FROM branch WHERE b_ID='$id'";
        ...
        <?php
            ...
            ?>
                    <h1 class="page-header">Updating branch: <?php echo $row1['b_name'];?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_editBranch.php?id=<?php echo $id;?>" enctype="multipart/form-data">
													<div class="form-group">
                                                    <label>Street Address *</label>
                                                    <input class="form-control" name='strAdd' value='<?php echo $row1['b_stradd'];?>'>
                                                    </div>
													<div class="form-group">
                                                    <label>Branch Name *</label>
                                                    <input class="form-control" name='brnName' value='<?php echo $row1['b_name'];?>'>
                                                    </div>
                                                    <div class="form-group">
