    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            ?>
                ...
                You cannot leave the text field for Bouquet Name empty.
                </div>
            <?php
            }  
            ?>
                    <h1 class="page-header">Adding a new bouquet type</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_addBouquetType.php" enctype="multipart/form-data">
													<div class="form-group">
                                                    <label>Bouquet Name</label>
                                                    <input class="form-control" name='bo_name'>
                                                    </div>
                                                    <div class="form-group">
                                                    <label>Description</label>
                                                    <textarea class="form-control" name='bo_desc' rows="3"></textarea>
                                                    </div>						
													<div class="form-group">
