    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				$echoQuery=mysqli_fetch_assoc($queryResult);
				?>
                    <h1 class="page-header"><?php echo $echoQuery['p_name']; ?></h1>
					<h4>Stock remaining: <?php echo $stnum; ?></h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                            <form method = "POST" action = "../functions/pro_newProdDistrib.php?id=<?php echo $id;?>&stnum=<?php echo $stnum;?>">
                                                    <?php
													
													$sql="SELECT * FROM branch WHERE b_status='Managed'";
													...
													<div class="form-group">
														...
														<input type="number" name="s_stock[<?php echo $row['b_ID']; ?>]" class= "form-control" min="0"/> 
                                                    </div>	
													<?php
													}
													}
