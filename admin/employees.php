    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="employees.php"><i class="fa fa-group fa-fw"></i> Employees</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            ?>
                ...
                You have successfully added a new branch manager!
                </div>
            <?php
            }   
            ...
            ?>
                <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                You have successfully fired a branch manager.
                </div>
            <?php
            }
                if(isset($_GET['fail'])){
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
						   Umbel Employees
                           <span class="navbar-right"><a href="new_manager.php"><button type="button" class="btn btn-primary btn-xs">Add a branch manager</button></a></span>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											...
											<th><center>Assigned Branch</center></th>
                                    ...
                                    <tbody>
									<?php
													$sql = "SELECT branch.*, user.* FROM branch LEFT JOIN user ON (branch.b_ID = user.b_id) WHERE b_status='Managed' AND u_position != 'Administrator'";
										...
										<tr class="odd gradeX">
											...
											<td><center><?php echo $row['u_fname'] . " " . $row['u_mname'] . " " . $row['u_lname']; ?></center></td>
											<td><center><?php echo $row['u_position'] ;?></center></td>
											<td><center><?php echo $row['b_name'] ;?></center></td>
                                            <td><center>
                                                <?php
                                                if ($row['u_position']=='Branch Manager'){
                                                ?>
                                                <a href = "../functions/pro_delEmployee.php?id=<?php echo $row['u_id']; ?>&bid=<?php echo $row['b_ID'];?>">
                                                <button type="button" class="btn btn-danger btn-sm"><b>x</b> Fire</button></a>
                                                <?php
                                                } else{
                                                ?>
                                                <a href = "../functions/pro_delEmployee.php?id=<?php echo $row['u_id']; ?>&bid=<?php echo $row['b_ID'];?>">
                                                <button type="button" class="btn btn-danger btn-sm" disabled><b>x</b> Fire</button></a>
                                                <?php
                                                }
                                                ?>
                                            </center></td>
