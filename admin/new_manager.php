...
<body>
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a active ="active" href="employees.php"><i class="fa fa-group fa-fw"></i> Employees</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            ?>
                    <h1 class="page-header">Assigning of branch manager</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			<div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
												<form method = "POST" action = "../functions/pro_addEmployee.php">
													...
													<?php
													$sql = "SELECT * from branch where b_status='Unmanaged'";
													$result=mysqli_query($con, $sql);
												
													if(mysqli_num_rows($result) > 0){
													?>
													 <option value="" disabled selected hidden>Assign a Branch</option>		
													<?php
													...
													?>
													<option value="" disabled selected hidden>There are no unmanaged branches.</option>		
													<?php
													}
													?>
													</select>
