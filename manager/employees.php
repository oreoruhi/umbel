    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            ?>
                <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                You have successfully fired an employee of your branch.
                </div>
            <?php
            }
                if(isset($_GET['fail'])){
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
						   Umbel Employees
                           <span class="navbar-right"><a href="new_employee.php"><button type="button" class="btn btn-primary btn-xs">Add an employee</button></a></span>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
                                        ...
                                        $sql="SELECT user.*, branch.* FROM user LEFT JOIN branch ON (user.b_ID = branch.b_ID) WHERE user.b_id='$condition' AND user.u_position != 'Administrator' AND user.u_position != 'Branch Manager'";
										...
										<tr class="odd gradeX">
											...
											<td><center><a href = "../functions/pro_delEmployee.php?id=<?php echo $row['u_id']; ?>&bid=<?php echo $row['b_ID'];?>"><button type="button" class="btn btn-danger btn-sm"><b>x</b> Fire</button></a></center></td>
										</td>
										</tr>
										<?php
											}
